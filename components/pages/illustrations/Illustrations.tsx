    ...
    <section className={styles["filter-list__container"]}>
      ...
      <div className={styles["filter-list-box"]}>
        <ul className={styles["filter-list"]}>
          <li data-filter="all" className={filter === "all" ? styles["is-active"] : ""} onClick={() => handleFilterClick("all")}><span>#すべて</span></li>
          <li data-filter="anime" className={filter === "アニメ" ? styles["is-active"] : ""} onClick={() => handleFilterClick("アニメ")}><span>#アニメ</span></li>
          <li data-filter="Vtuber" className={filter === "Vtuber" ? styles["is-active"] : ""} onClick={() => handleFilterClick("Vtuber")}><span>#Vtuber</span></li>
          <li data-filter="VOCALOID" className={filter === "ボカロ" ? styles["is-active"] : ""} onClick={() => handleFilterClick("ボカロ")}><span>#ボカロ</span></li>
          <li data-filter="game" className={filter === "ゲーム" ? styles["is-active"] : ""} onClick={() => handleFilterClick("ゲーム")}><span>#ゲーム</span></li>
        </ul>
      </div>
      ...
      <div id={styles.grayDisplay} className={`${styles.grayDisplay} ${isGrayDisplayVisible ? styles.visible : ""}`} onClick={handleOverlayClick}>
