  ...
  return (
    <section className={styles.games} id="games">
      <div className={styles.decorationArea}>
        ...
        <img
          className={styles.gamesDecoration1}
          src="/images/Games/Games_decoration1.png"
          alt="あしらい"
        />
        <img
          className={styles.gamesDecoration2}
          src="/images/Games/Games_decoration2.png"
          alt="あしらい"
        />
